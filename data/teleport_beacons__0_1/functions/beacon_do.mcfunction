...
execute at @e[type=armor_stand,name=teleport_target,limit=1] as @e[tag=teleport_paired,tag=!teleport_cooldown,distance=..3,limit=1,sort=nearest] run function teleport_beacons__0_1:beacon_disable 
